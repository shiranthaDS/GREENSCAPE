...
const UpdateEmployee = () => {
  ...
  const updateData = (e) => {
    ...
    const updatedEmployee = { name, nic, email, address, gender, phone, status, role, department, emid };
    ...
    <div className="container">
      <form onSubmit={updateData}>
        ...
        <div className="form-group">
          ...
          <input type="text" className="form-control" value={emid} onChange={(e) => setEmid(e.target.value)} />
        </div>
